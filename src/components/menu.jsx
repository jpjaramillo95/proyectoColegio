    ...
    <div>
            ...
            <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                <div className="relative flex h-16 items-center justify-between">
                    <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                        {/* <!-- Mobile menu button--> */}
                        <button type="button" className="relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-white hover:text-blue-950 focus:ring-2 focus:ring-white focus:outline-hidden focus:ring-inset" aria-controls="mobile-menu" aria-expanded="false">
                    ...
                    <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        ...
                        <div className="hidden sm:ml-6 sm:block">
                            <div className="flex space-x-4">
                                ...
                                <Link to="#" className="rounded-md bg-blue-400 px-3 py-2 text-sm font-bold text-blue-950" aria-current="page">Inicio</Link>
                                <Link to="#" className="rounded-md px-3 py-2 text-sm font-semibold text-gray-300 hover:bg-gray-700 hover:text-white" aria-current="page">Matricula</Link>
                                <Link to="#" className="rounded-md px-3 py-2 text-sm font-semibold text-gray-300 hover:bg-gray-700 hover:text-white">Materias</Link>
                                <Link to="#" className="rounded-md px-3 py-2 text-sm font-semibold text-gray-300 hover:bg-gray-700 hover:text-white">Tareas</Link>
                                <Link to="#" className="rounded-md px-3 py-2 text-sm font-semibold text-gray-300 hover:bg-gray-700 hover:text-white">Examenes</Link>
                                <Link to="#" className="rounded-md px-3 py-2 text-sm font-semibold text-gray-300 hover:bg-gray-700 hover:text-white">Calendario</Link>
                            </div>
                        </div>
                    </div>
                    <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        ...
                        <div className="relative ml-3">
                            ...
                            <div className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black/5 focus:outline-hidden" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabIndex="-1">
                                ...
                                <Link to="#" className="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabIndex="-1" id="user-menu-item-0">Ver perfil</Link>
                                <Link to="#" className="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabIndex="-1" id="user-menu-item-2">Salir</Link>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        {/* <Navbar fluid rounded>
            <NavbarBrand to="https://flowbite-react.com">
                ...
                <span classNameName="self-center whitespace-nowrap text-xl font-semibold dark:text-white">Flowbite React</span>
            </NavbarBrand>
            <div classNameName="flex md:order-2">
                ...
                inline
                label={
                    <Linkvatar alt="User settings" img="https://flowbite.com/docs/images/people/profile-picture-5.jpg" rounded />
                }
                >
                <DropdownHeader>
                    <span classNameName="block text-sm">Bonnie Green</span>
                    <span classNameName="block truncate text-sm font-medium">name@flowbite.com</span>
                </DropdownHeader>
