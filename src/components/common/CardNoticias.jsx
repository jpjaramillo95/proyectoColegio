  ...
  return (
    <>
      <div className="contenedorNoticia">
        ...
        <p className=''> Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias rem corporis a enim sapiente temporibus quae illo quis molestias dolores, totam, maiores quibusdam numquam quod esse quasi ipsa provident recusandae!</p>
